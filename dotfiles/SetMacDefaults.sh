...
# A subset of the settings found here:
...
# Example: http://arstechnica.com/apple/2014/10/os-x-10-10/5/
...
# Save screenshots to my temp folder
...
# Show select hard drives on Desktop
...
defaults write com.apple.Safari HomePage -string "https://andrew.cmu.edu/user/skrulcik"
...
# TODO(Scott) Add list of ignored directories
